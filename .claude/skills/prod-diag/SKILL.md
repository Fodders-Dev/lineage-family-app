...
Норма после SPEED-6: access 1–3мс, persist 7–15мс, ack < 30мс серверных.
Всплески access/persist до ~300мс под бёрстом = CPU-контеншн фоновых
блоб-записей фан-аута (notifications/pushDeliveries) — известный остаток.
